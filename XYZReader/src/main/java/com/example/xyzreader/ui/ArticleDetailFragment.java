...
public class ArticleDetailFragment extends Fragment implements
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            Typeface typeface = Typeface.createFromAsset(getActivity().getAssets(), "PatuaOne.ttf");
                            ...
                            Palette.from(resource).generate(new Palette.PaletteAsyncListener() {
                                ...
                                public void onGenerated(Palette palette) {
                                    ...
                                    if (vibrant != null) {
                                        ...
                                        bodyView.setLinkTextColor(vibrant.getRgb());
                                        mRootView.findViewById(R.id.share_fab).setBackgroundTintList(ColorStateList.valueOf(vibrant.getRgb()));
                                    } else {

                                        Palette.Swatch muted = palette.getMutedSwatch();

                                        if (muted != null) {
                                            mMutedColor = muted.getRgb();
                                            metaBar.setBackgroundColor(muted.getRgb());
                                            bodyView.setLinkTextColor(muted.getRgb());
                                            mRootView.findViewById(R.id.share_fab).setBackgroundTintList(ColorStateList.valueOf(muted.getRgb()));
                                        }
